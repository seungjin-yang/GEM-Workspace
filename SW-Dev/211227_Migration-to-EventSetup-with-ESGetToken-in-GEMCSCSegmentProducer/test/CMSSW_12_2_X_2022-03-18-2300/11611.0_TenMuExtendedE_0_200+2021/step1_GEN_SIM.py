...
# with command line options: TenMuExtendedE_0_200_pythia8_cfi --step GEN,SIM --number 10 --conditions auto:phase1_2021_realistic --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --fileout file:step1.root --no_exec --python_filename step1_GEN_SIM.py
...
process.generator = cms.EDFilter("Pythia8EGun",
    PGunParameters = cms.PSet(
        ...
        MaxEta = cms.double(1.53), # 1.55 - 0.02
        MaxPhi = cms.double(3.14159265359),
        MinE = cms.double(0.0),
        MinEta = cms.double(2.20), # 2.18 + 0.02
