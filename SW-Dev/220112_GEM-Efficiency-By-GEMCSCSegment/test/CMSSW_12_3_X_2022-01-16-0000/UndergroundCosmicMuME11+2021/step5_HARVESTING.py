...
# with command line options: step5 --mc --conditions auto:phase1_2021_cosmics --era Run3 --scenario cosmics --geometry DB:Extended --magField 0T --step HARVESTING:gemClientsCosmics --filetype DQM --number -1 --filein file:step4.root --fileout file:step5.root --no_exec
...
process.dqmHarvesting = cms.Path(process.GEMDQMHarvester)
