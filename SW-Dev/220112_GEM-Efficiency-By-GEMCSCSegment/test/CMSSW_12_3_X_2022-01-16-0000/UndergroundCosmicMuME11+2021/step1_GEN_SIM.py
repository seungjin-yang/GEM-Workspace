...
# with command line options: GEMDQMUtils/Generator/python/UndergroundCosmicMuME11_cfi --mc --conditions auto:phase1_2021_cosmics --era Run3 --scenario cosmics --geometry DB:Extended --magField 0T --step GEN,SIM --number 50000 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --datatier GEN-SIM --eventcontent FEVTDEBUG --fileout file:step1.root --python_filename step1_GEN_SIM.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('GEMDQMUtils/Generator/python/UndergroundCosmicMuME11_cfi nevts:50000'),
...
process.ME11GenFilter = cms.EDFilter("ME11GenFilter",
    hepMCProductTag = cms.InputTag("generator","unsmeared"),
    mightGet = cms.optional.untracked.vstring,
    propagatorTag = cms.ESInputTag("","SteppingHelixPropagatorAlong")
)
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.ME11GenFilter)
