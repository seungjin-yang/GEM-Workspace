...
# with command line options: step3 --mc --conditions auto:phase1_2021_cosmics --era Run3 --scenario cosmics --geometry DB:Extended --magField 0T --step RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --number -1 --eventcontent FEVT --filein file:step2.root --fileout file:step3.root --no_exec
