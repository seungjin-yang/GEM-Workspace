#!/bin/sh
# /pad/seyang/Projects/GEM-Workspace/SW-Dev/220112_GEM-Efficiency-By-GEMCSCSegment/test/CMSSW_12_3_0_pre5/UndergroundCosmicMuNoFilter0T+2021
PROJECT_HOME=$(dirname $(dirname $(dirname $(pwd))))
CMSSW_VERSION=$(basename $(dirname $(pwd)))
SAMPLE=$(basename $(pwd))
