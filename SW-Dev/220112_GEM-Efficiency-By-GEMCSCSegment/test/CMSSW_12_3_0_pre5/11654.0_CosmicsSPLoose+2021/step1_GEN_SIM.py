...
# with command line options: UndergroundCosmicSPLooseMu_cfi --step GEN,SIM --number 10000 --conditions auto:phase1_2021_realistic --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --fileout file:step1.root --no_exec --python_filename step1_GEN_SIM.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('UndergroundCosmicSPLooseMu_cfi nevts:10000'),
