...
# with command line options: step4 --mc --conditions auto:phase1_2021_cosmics --era Run3 --scenario cosmics --geometry DB:Extended --magField 0T --no_exec --step DQM:gemEffByGEMCSCSegment --datatier DQMIO --number -1 --eventcontent DQM --filein file:step3.root --fileout file:step4.root
