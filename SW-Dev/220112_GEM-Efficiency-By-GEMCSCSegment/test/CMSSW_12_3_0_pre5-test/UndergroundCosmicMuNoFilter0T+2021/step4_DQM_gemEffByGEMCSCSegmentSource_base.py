...
process.gemcscSegmentsReco = cms.Sequence(
...
process.gemcscSegmentsReco_step = cms.Path(process.gemcscSegmentsReco)
process.gemEffByGEMCSCSegmentSource_step = cms.EndPath(process.gemEffByGEMCSCSegmentSource)
process.DQMoutput_step = cms.EndPath(process.DQMoutput)

# Schedule definition
process.schedule = cms.Schedule(
    process.gemcscSegmentsReco_step,
