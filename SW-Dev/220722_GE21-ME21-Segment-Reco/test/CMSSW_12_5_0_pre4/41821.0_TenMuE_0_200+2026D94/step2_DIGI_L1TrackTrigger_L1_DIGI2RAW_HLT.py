...
# with command line options: step2 --step DIGI:pdigi_valid,L1TrackTrigger,L1,DIGI2RAW,HLT:@fake2 --conditions auto:phase2_realistic_T21 --datatier GEN-SIM-DIGI-RAW --number -1 --eventcontent FEVTDEBUGHLT --geometry Extended2026D94 --era Phase2C17I13M9 --filein file:step1.root --fileout file:step2.root --no_exec
