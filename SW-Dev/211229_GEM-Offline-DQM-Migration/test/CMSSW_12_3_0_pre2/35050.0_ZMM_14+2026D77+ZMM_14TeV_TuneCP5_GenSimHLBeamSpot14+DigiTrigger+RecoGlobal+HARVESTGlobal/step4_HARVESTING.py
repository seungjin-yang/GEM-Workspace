...
# with command line options: step4 -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --conditions auto:phase2_realistic_T21 --mc --geometry Extended2026D77 --scenario pp --filetype DQM --era Phase2C11I13M9 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
