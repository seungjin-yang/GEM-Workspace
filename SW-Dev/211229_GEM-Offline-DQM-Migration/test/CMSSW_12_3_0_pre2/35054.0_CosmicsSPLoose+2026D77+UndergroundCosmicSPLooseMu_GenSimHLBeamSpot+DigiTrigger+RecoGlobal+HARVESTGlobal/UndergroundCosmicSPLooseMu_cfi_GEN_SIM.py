...
# with command line options: UndergroundCosmicSPLooseMu_cfi -s GEN,SIM -n 10 --conditions auto:phase2_realistic_T21 --beamspot HLLHC --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry Extended2026D77 --era Phase2C11I13M9 --relval 9000,50 --fileout file:step1.root
