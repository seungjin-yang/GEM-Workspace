...
# with command line options: step3 --step RAW2DIGI,L1Reco,RECO --conditions auto:phase1_2023_realistic --datatier GEN-SIM-RECO --number -1 --eventcontent RECOSIM --geometry DB:Extended --era Run3 --filein file:step2.root --fileout file:step3.root --no_exec
