...
# with command line options: step5 --step HARVESTING:gemClients --conditions auto:phase1_2023_realistic --mc --geometry DB:Extended --scenario pp --filetype DQM --era Run3 --number -1 --filein file:step4.root --fileout file:step5.root --no_exec
