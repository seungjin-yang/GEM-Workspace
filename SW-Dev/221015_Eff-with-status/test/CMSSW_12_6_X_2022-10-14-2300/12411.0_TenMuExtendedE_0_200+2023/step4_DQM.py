...
# with command line options: step4 --step DQM:gemSources --conditions auto:phase1_2023_realistic --datatier DQMIO --number -1 --eventcontent DQM --geometry DB:Extended --era Run3 --filein file:step3.root --fileout file:step4.root --no_exec
