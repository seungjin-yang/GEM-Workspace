...
# with command line options: TenMuExtendedE_0_200_pythia8_cfi --step GEN,SIM --number 100 --conditions auto:phase1_2023_realistic --beamspot Realistic25ns13p6TeVEarly2022Collision --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --fileout file:step1.root --python_filename step1_GEN_SIM.py --no_exec
