...
# with command line options: step5 --step HARVESTING:gemClients --conditions auto:run3_data --data --filetype DQM --scenario pp --number -1 --filein file:step4.root --fileout file:step5.root --no_exec
