...
# with command line options: step4 --conditions 122X_mcRun3_2021_realistic_v5 --era Run3,run3_nanoAOD_devel --filein file:step3_inDQM.root --fileout file:step4.root --filetype DQM --geometry DB:Extended --mc --no_exec --number 10 --python_filename test_step4_cfg.py --scenario pp --step HARVESTING:@standardValidation+@standardDQM+@ExtraHLT+@miniAODValidation+@miniAODDQM+@nanoAODDQM --no_exec
