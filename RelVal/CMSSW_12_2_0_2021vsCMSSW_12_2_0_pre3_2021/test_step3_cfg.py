...
# with command line options: step3 --conditions 122X_mcRun3_2021_realistic_v5 --datatier GEN-SIM-RECO,MINIAODSIM,NANOAODSIM,DQMIO --era Run3,run3_nanoAOD_devel --eventcontent RECOSIM,MINIAODSIM,NANOEDMAODSIM,DQM --filein file:step2.root --fileout file:step3.root --geometry DB:Extended --no_exec --number 10 --python_filename test_step3_cfg.py --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,NANO,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM+@nanoAODDQM --no_exec
...
process.GlobalTag = GlobalTag(process.GlobalTag, '122X_mcRun3_2021_realistic_v5', '')
